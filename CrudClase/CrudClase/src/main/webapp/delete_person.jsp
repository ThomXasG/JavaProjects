...
<html>
    ...
    <body>
        <%
        String idDel = request.getParameter("cedula");
        
        if (idDel != null && !idDel.isEmpty()) {
            try {
                    String urlString = "http://localhost/QUINTO/api.php?cedula=" + idDel;
                    ...
                    if (respuesta.statusCode() == 200) {
                        ...
                        out.print("<br>");
                        response.sendRedirect("lista_estudiantes.jsp"); // Redireccionar a la lista de personas
                    } else {
